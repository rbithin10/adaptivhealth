...
-- =============================================================================
-- ALTER TABLE patient_medications ADD COLUMN reminder_time VARCHAR(5);
-- ALTER TABLE patient_medications ADD COLUMN reminder_enabled BOOLEAN DEFAULT 0;
--
-- CREATE TABLE IF NOT EXISTS medication_adherence (
--     adherence_id INTEGER PRIMARY KEY AUTOINCREMENT,
--     medication_id INTEGER NOT NULL REFERENCES patient_medications(medication_id) ON DELETE CASCADE,
--     user_id INTEGER NOT NULL REFERENCES users(user_id) ON DELETE CASCADE,
--     scheduled_date DATE NOT NULL,
--     taken BOOLEAN,
