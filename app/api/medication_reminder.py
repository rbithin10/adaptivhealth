...
async def create_medication_reminder(
    ...
    medication = (
        ...
        .filter(
            and_(
                PatientMedication.medication_id == payload.medication_id,
    ...
    medication.reminder_time = payload.reminder_time
    medication.reminder_enabled = payload.reminder_enabled
...
async def get_adherence_history(
    ...
    total_scheduled = len(medications) * days
    ...
    med_names = {med.medication_id: med.drug_name for med in medications}
    ...
    adherence_percent = (total_taken / total_scheduled * 100) if total_scheduled > 0 else 0.0
